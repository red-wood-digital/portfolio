...
export const COMPANY_NAME = "Red Wood Digital";
export const CONTACT_PHONE_NUMBER = "+8801775390977";
export const CONTACT_EMAIL_ADDRESS = "redwooddigital303@gmail.com";

export const SOCIAL_LINKS = [
  {
    icon: Facebook,
    media: "Facebook",
    url: "https://www.facebook.com/red.wood.digital",
  },
  {
    icon: Instagram,
    media: "Instagram",
    url: "https://www.instagram.com/red.wood.digital",
  },
  {
    icon: Twitter,
    media: "Twitter",
    url: "https://www.twitter.com/red.wood.digital",
  },
  {
    icon: Github,
    media: "Github",
    url: "https://www.github.com/red.wood.digital",
  },
  {
    icon: Linkedin,
    media: "Linkedin",
    url: "https://www.linkedin.com/red.wood.digital",
  },
];
...
export const TESTIMONIALS = [
  {
    ...
    designation: "A Tale of Two Cities",
  ...
  },
  {
    ...
    designation: "A Dream Within a Dream",
    avatar: "https://images.unsplash.com/photo-1595152772835-219674b2a8a6",
...
export const TEAM_MEMBERS = [
  {
    ...
    image: "/images/Mahtab-Tanay.png",
    socialLinks: [
      {
        icon: Facebook,
        media: "Facebook",
        url: "https://www.facebook.com/rastrick.tanay",
      },
      {
        icon: Instagram,
        media: "Instagram",
        url: "https://www.instagram.com/rastrick.tanay",
      },
      {
        icon: Linkedin,
        media: "Linkedin",
        url: "https://www.linkedin.com/rastrick.tanay",
      },
    ],
  },
];
...
export const SERVICES_REVIEWS = [
  {
    key: "branding",
    reviews: [
      "/images/services/branding/reviews/1.jpg",
      "/images/services/branding/reviews/2.jpg",
      "/images/services/branding/reviews/3.jpg",
      "/images/services/branding/reviews/4.jpg",
      "/images/services/branding/reviews/5.jpg",
      "/images/services/branding/reviews/6.jpg",
      "/images/services/branding/reviews/7.jpg",
      "/images/services/branding/reviews/8.jpg",
      "/images/services/branding/reviews/9.jpg",
      "/images/services/branding/reviews/10.jpg",
      "/images/services/branding/reviews/11.jpg",
      "/images/services/branding/reviews/12.jpg",
      "/images/services/branding/reviews/13.jpg",
      "/images/services/branding/reviews/14.jpg",
      "/images/services/branding/reviews/15.jpg",
      "/images/services/branding/reviews/16.jpg",
      "/images/services/branding/reviews/17.jpg",
      "/images/services/branding/reviews/18.jpg",
      "/images/services/branding/reviews/19.jpg",
      "/images/services/branding/reviews/20.jpg",
    ],
  },
  { key: "web-development", reviews: [] },
];
